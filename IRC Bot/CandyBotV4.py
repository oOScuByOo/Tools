...
def AvoirLePass(): # Fonction pour avoir le mot de passe
    ...
    while 1:
        ...
        if POUBELLE.find(":")>-1: # Verifie le MP pour etre sur d'avoir la chaine encodee
            ...
            POUBELLE=POUBELLE[:POUBELLE.find(".")]         # Doit ressembler a quelque chose comme "fX5vLOaAphGHxuRAkxbbEK1aounUq"
            print(POUBELLE)
            REPONSE=str(POUBELLE[(POUBELLE.find(":"))+1:])
            print "Chaine compresser / encodee : " + REPONSE
            REPONSE=base64.b64decode(REPONSE); # Decode en Base64
            print "Chaine compresser / decodee : " + REPONSE
            REPONSE = zlib.decompress(REPONSE) # Decompresse la chaine avec Zlib
            print "Chaine decompresser / decodee: " + REPONSE
            BOT.send("PRIVMSG "+TARGET+" :!ep4 -rep "+REPONSE+"\r\n") # Envoie la reponse a Candy
...
USERNAME = 'V4' # Variable 2 de l'username du Bot
