...
import codecs # Ajout librairie Codecs (Gere le ROT13)
...
def AvoirLePass(): # Fonction pour avoir le mot de passe
    ...
    while 1:
        ...
        if POUBELLE.find(":")>-1: # Verifie le MP pour etre sur d'avoir la chaine encodee
            ...
            REPONSE=codecs.decode(REPONSE, 'rot_13') # Decode en ROT13
            print "Chaine decodee : " + REPONSE
            BOT.send("PRIVMSG "+TARGET+" :!ep3 -rep "+REPONSE+"\r\n") # Envoie la reponse a Candy
...
USERNAME = 'V3' # Variable 2 de l'username du Bot
